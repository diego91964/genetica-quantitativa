...
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[width=\paperwidth]{template/background}}; % Background image
...
\include{chapters/c01}

%\include{chapters/c02}
